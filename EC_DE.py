...
if __name__ == "__main__":
    ...
    ec_de = EC_DE(central_ip, central_puerto, sensores_ip, sensores_puerto,import socket
import threading
import time
import json
import argparse
...
if __name__ == "__main__":
    ...
    ec_de = EC_DE(central_ip, central_puerto, sensores_ip, sensores_puerto, taxi_id) taxi_id)